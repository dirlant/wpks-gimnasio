...
//add_action( 'admin_menu', 'wpks_eliminar_menu_administracion' );

function wpks_eliminar_menu_administracion() {
  ...
  remove_menu_page('edit-comments.php.php'); // Remueve la opcion de comentarios
